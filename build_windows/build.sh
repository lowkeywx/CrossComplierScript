...
#SOURCE_NAMES="abseil-cpp-20200923 libyuv libuv-1.40.0 protobuf-3.3.0 webrtcAudioProcess opus-1.2-rc1"
SOURCE_NAMES="libuuid-1.0.3"

echo "====================================windows-${SOURCE_NAMES}======================================"
...
do
    ...
    if [ "$SRC_NAME" = "opus-1.2-rc1" ]; then
        ...
        make -j 8
        make install
    elif [ "$SRC_NAME" = "libuuid-1.0.3" ]; then
