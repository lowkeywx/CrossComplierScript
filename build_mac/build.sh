...
#otool -lv libuv-1.40.0/lib/libuv_a.a |grep -i version -A 5 -B 5

#SOURCE_NAMES="abseil-cpp-20200923 libyuv libuv-1.40.0 protobuf-3.3.0 webrtcAudioProcess opus-1.2-rc1 openssl-1.1.1h c-ares curl-7.73.0 x264-master"
...
echo "====================================ubuntu-${SRC_NAME}======================================"
    ...
    export BS_CMAKE_SHARE_ARGUMENTS="-DCMAKE_BUILD_TYPE=${BS_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${BS_INSTALL_PATH} -DCMAKE_OSX_DEPLOYMENT_TARGET=${MACOSX_DEPLOYMENT_TARGET}"
